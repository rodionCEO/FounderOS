...
export default {
  ...
  'search.prompt': 'Type a query and press Enter',
  ...
  // Dashboard
  'dash.focus': 'Focus Day',
  'dash.focusEmpty': 'Add up to 3 key tasks to focus on today',
  ...
  'tasks.importanceLabel': 'Importance',
  'tasks.view': 'View',
  'tasks.viewGrouped': 'By group',
  ...
  'tasks.emptyHint': 'Create your first task',
  'tasks.groupEmpty': 'Nothing here',
  'tasks.allEmpty': 'No matching tasks',
  'tasks.focusLimit': 'You can focus on up to 3 tasks',
  'tasks.focusAdd': 'Add to Focus Day',
  'tasks.focusRemove': 'Remove from Focus Day',
  'tasks.dlToday': 'Today',
  'tasks.dlTomorrow': 'Tomorrow',
  'tasks.dlNextWeek': 'Next week',
  'tasks.dlClear': 'No date',
  'tasks.due': 'due',
  ...
  'ideas.emptyHint': 'Capture your next idea',
  'ideas.pinned': 'Pinned',
  'ideas.all': 'All ideas',
  'sort.newest': 'Newest',
  'sort.oldest': 'Oldest',
  ...
  'notes.emptyHint': 'Write your first note',
  'notes.pinned': 'Pinned',
  'notes.all': 'All notes',
  ...
  'links.emptyHint': 'Save your first link',
  ...
  'journal.emptyHint': 'Start your daily log',
